...
sudo install -m 0644 "$artifact_path" "$release_dir/originlens-release-candidate.zip"
sudo install -m 0644 "$checksum_path" "$release_dir/originlens-release-candidate.zip.sha256"
...
printf '%s\n' 'Deployment complete.'
printf '%s\n' 'Download: https://fixtures.example.invalid/originlens-release-candidate.zip'
printf '%s\n' 'Checksum: https://fixtures.example.invalid/originlens-release-candidate.zip.sha256'

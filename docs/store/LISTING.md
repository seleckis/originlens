# Chrome Web Store listing — OriginLens v0.1.4

Status: publication-ready copy for the verified v0.1.4 upload. Copy changes
...
- Official verified publisher URL: none for v0.1.4
